...
solution options set /Input/SearchPath {../inc ../keras_econ_4x4_v4/firmware/ ../keras_econ_4x4_v4/firmware/weights ../keras_econ_4x4_v4/firmware/nnet_utils}

# Add source files.
solution file add ../keras_econ_4x4_v4/firmware/econ_4x4_v4.cpp -type C++
solution file add ../keras_econ_4x4_v4/sc_main.cpp -type C++ -exclude true
...
#directive set -DESIGN_HIERARCHY econ_4x4_v4
...
if {$opt(hsynth)} {
    ...
    directive set /econ_4x4_v4/nnet::conv_2d<input_t,layer2_t,config2> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::conv_2d<layer3_t,layer4_t,config4> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::conv_2d<layer5_t,layer6_t,config6> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::relu<layer2_t,layer3_t,relu_config3> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::relu<layer4_t,layer5_t,relu_config5> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::relu<layer6_t,layer7_t,relu_config7> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::relu<layer8_t,result_t,relu_config9> -MAP_TO_MODULE {[CCORE]}
    directive set /econ_4x4_v4/nnet::dense_large<layer7_t,layer8_t,config8> -MAP_TO_MODULE {[CCORE]}

    # Retains the solution for the CCOREs within the project.
    directive set /econ_4x4_v4/nnet::conv_2d<input_t,layer2_t,config2> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::conv_2d<layer3_t,layer4_t,config4> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::conv_2d<layer5_t,layer6_t,config6> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::relu<layer2_t,layer3_t,relu_config3> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::relu<layer4_t,layer5_t,relu_config5> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::relu<layer6_t,layer7_t,relu_config7> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::relu<layer8_t,result_t,relu_config9> -CCORE_DEBUG true
    directive set /econ_4x4_v4/nnet::dense_large<layer7_t,layer8_t,config8> -CCORE_DEBUG true


    # BUGFIX: This prevents the creation of the empty module CGHpart. In the
    # next releases of Catapult HLS, this may be fixed.
    directive set /econ_4x4_v4 -GATE_EFFORT normal
    ...
    # Arrays
    directive set /econ_4x4_v4/nnet::conv_2d<input_t,layer2_t,config2>(input_3):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::conv_2d<layer3_t,layer4_t,config4>(layer3_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::conv_2d<layer5_t,layer6_t,config6>(layer5_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::relu<layer2_t,layer3_t,relu_config3>(layer2_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::relu<layer4_t,layer5_t,relu_config5>(layer4_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::relu<layer6_t,layer7_t,relu_config7>(layer6_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::relu<layer8_t,result_t,relu_config9>(layer8_out):rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_v4/nnet::dense_large<layer7_t,layer8_t,config8>(layer7_out):rsc -MAP_TO_MODULE {[Register]}
    
    # Loops
    directive set /econ_4x4_v4/nnet::conv_2d<input_t,layer2_t,config2>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::conv_2d<layer3_t,layer4_t,config4>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::conv_2d<layer5_t,layer6_t,config6>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::relu<layer2_t,layer3_t,relu_config3>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::relu<layer4_t,layer5_t,relu_config5>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::relu<layer6_t,layer7_t,relu_config7>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::relu<layer8_t,result_t,relu_config9>/core/main -UNROLL no
    directive set /econ_4x4_v4/nnet::dense_large<layer7_t,layer8_t,config8>/core/main -UNROLL no
