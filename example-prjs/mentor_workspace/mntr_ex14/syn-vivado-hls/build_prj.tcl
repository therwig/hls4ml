...
open_project -reset econ_4x4_v4_prj
set_top econ_4x4_v4
add_files ../keras_econ_4x4_v4/firmware/econ_4x4_v4.cpp -cflags "-std=c++0x"
add_files -tb ../keras_econ_4x4_v4/sc_main.cpp -cflags "-std=c++0x -D__WEIGHTS_FROM_FILE__"
add_files -tb ../keras_econ_4x4_v4/firmware/weights
...
if {$opt(synth)} {
  ...
  if {$opt(cosim)} {
    ...
    add_files -tb ../keras_econ_4x4_v4/sc_main.cpp -cflags "-std=c++0x -DRTL_SIM -D__WEIGHTS_FROM_FILE__"
    set time_start [clock clicks -milliseconds]
