...
if {$opt(reset)} {
  open_project -reset myproject_update_prj
} else {
  open_project myproject_update_prj
}
set_top myproject_2d
add_files firmware/myproject_update.cpp -cflags "-std=c++0x"
add_files -tb myproject_test_update.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb myproject_test_update.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
