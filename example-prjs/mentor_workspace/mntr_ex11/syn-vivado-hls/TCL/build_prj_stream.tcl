...
set_top myproject
add_files ../myproject/firmware/myproject.cpp -cflags "-std=c++0x"
add_files -tb ../myproject/sc_main.cpp -cflags "-std=c++0x"
add_files -tb ../myproject/firmware/weights
...
if {$opt(cosim)} {
  ...
  add_files -tb ../myproject/sc_main.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
