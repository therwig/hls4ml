...
add_files firmware/econ_4x4_d10.cpp -cflags "-std=c++0x"
add_files -tb econ_4x4_d10_test.cpp -cflags "-std=c++0x"
...
if {$opt(synth)} {
  ...
  if {$opt(cosim)} {
    ...
    add_files -tb econ_4x4_d10_test.cpp -cflags "-std=c++0x -DRTL_SIM"
    set time_start [clock clicks -milliseconds]
