...
open_project -reset econV2_prj
set_top econV2
add_files ../keras_econV2/firmware/econV2.cpp -cflags "-std=c++0x"
add_files -tb ../keras_econV2/sc_main.cpp -cflags "-std=c++0x -D__WEIGHTS_FROM_FILE__"
add_files -tb ../keras_econV2/firmware/weights
...
if {$opt(synth)} {
  ...
  if {$opt(cosim)} {
    ...
    add_files -tb ../keras_econV2/sc_main.cpp -cflags "-std=c++0x -DRTL_SIM -D__WEIGHTS_FROM_FILE__"
    set time_start [clock clicks -milliseconds]
