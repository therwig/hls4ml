...
set data_inputs [list input_1_rsc_vld {input_1_rsc_dat[*]} layer5_out_rsc_rdy const_size_in_1_rsc_rdy const_size_out_1_rsc_rdy w2_rsc_vld {w2_rsc_dat[*]} b2_rsc_vld {b2_rsc_dat[*]} w4_rsc_vld {w4_rsc_dat[*]} b4_rsc_vld {b4_rsc_dat[*]}]
