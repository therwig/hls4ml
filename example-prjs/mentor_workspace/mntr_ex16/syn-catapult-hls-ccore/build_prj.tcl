...
directive set -DESIGN_HIERARCHY { \
    econ_4x4_d10 \
    {nnet::conv_2d<ac_fixed<22, 2, true, AC_TRN, AC_WRAP>, ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, config2>} \
    {nnet::relu<ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, relu_config3>} \
    {nnet::relu<ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, relu_config5>} \
    {nnet::dense_large<ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, ac_fixed<22, 4, true, AC_TRN, AC_WRAP>, config4>} \
}
...
if {$opt(hsynth)} {
    ...
    #directive set /econ_4x4_d10/nnet::conv_2d<input_t,layer2_t,config2> -CCORE_TYPE combinational
    #directive set /econ_4x4_d10/nnet::relu<layer2_t,layer3_t,relu_config3> -CCORE_TYPE combinational
    #directive set /econ_4x4_d10/nnet::relu<layer4_t,result_t,relu_config5> -CCORE_TYPE combinational
    #directive set /econ_4x4_d10/nnet::dense_large<layer3_t,layer4_t,config4> -CCORE_TYPE combinational
    ...
    directive set /econ_4x4_d10/core/nnet::conv_2d<input_t,layer2_t,config2>(w2)#1:rsc -MAP_TO_MODULE {[Register]}
    directive set /econ_4x4_d10/core/nnet::dense_large<layer3_t,layer4_t,config4>(w2):rsc -MAP_TO_MODULE {[Register]}
    ...
    directive set /econ_4x4_d10/core/nnet::dense_large<layer3_t,layer4_t,config4>(w2)#1:rsc -MAP_TO_MODULE {[Register]}
