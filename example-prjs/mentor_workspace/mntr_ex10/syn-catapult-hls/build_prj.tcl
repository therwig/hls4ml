...
solution options set /Input/SearchPath {../inc ../econV1/firmware/ ../econV1/firmware/weights ../econV1/firmware/nnet_utils}

# Add source files.
solution file add ../keras_econV1/firmware/econV1.cpp -type C++
solution file add ../keras_econV1/sc_main.cpp -type C++ -exclude true
...
#directive set -DESIGN_HIERARCHY econV1
...
directive set -DESIGN_HIERARCHY { \
    ...
    {nnet::conv_2d<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, config5>} \
    ...
    {nnet::relu<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, relu_config6>} \
    {nnet::relu<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, relu_config9>} \
    {nnet::pooling2d<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, config4>} \
    {nnet::pooling2d<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, config7>} \
    {nnet::pooling2d<ac_fixed<18, 8, true, AC_TRN, AC_WRAP>, config10>} \
}
...
if {$opt(hsynth)} {
    ...
    directive set /econV1 -GATE_EFFORT normal
    ...
    ## DEPRECATED
    ##directive set /econV1/input_1:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_vld
    ##directive set /econV1/layer5_out:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_vld

    directive set /econV1/input_1:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait
    directive set /econV1/layer10_out:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_wait
    directive set /econV1/const_size_in_1:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_vld
